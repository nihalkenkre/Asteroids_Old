...
material::material (const tinygltf::Material& material, const tinygltf::Model& model) : name (material.name)
{
    ...
    base_color_factor = { (float)material.pbrMetallicRoughness.baseColorFactor.at (0), (float)material.pbrMetallicRoughness.baseColorFactor.at (1), (float)material.pbrMetallicRoughness.baseColorFactor.at (2), (float)material.pbrMetallicRoughness.baseColorFactor.at (3) };
}
