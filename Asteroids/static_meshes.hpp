...
public:
    ...
    static_graphics_primitives opaque_graphics_primitives;
    static_graphics_primitives alpha_graphics_primitives;
    static_graphics_primitives blend_graphics_primitives;
};
